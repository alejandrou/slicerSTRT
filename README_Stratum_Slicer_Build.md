...
Instrucciones para compilar 3D Slicer desde código fuente dentro del proyecto `C:\slicerSTRT`.
...
```text
C:\slicerSTRT\source                 Código fuente de Slicer
C:\slicerSTRT\apps\SR                Carpeta de build Release / SuperBuild
C:\slicerSTRT\apps\SR\Slicer-build   Carpeta final donde queda Slicer.exe
C:\slicerSTRT\workspace\build_scripts Scripts .bat de build
C:\slicerSTRT\extensions             Futuras extensiones o módulos
```
...
dir C:\slicerSTRT\source\CMakeLists.txt
dir C:\slicerSTRT\source\.git
```

Si `CMakeLists.txt` no está en `C:\slicerSTRT\source`, comprobar si está en:

```bat
dir C:\slicerSTRT\source\Slicer\CMakeLists.txt
```
...
```text
C:\slicerSTRT\workspace\build_scripts
```
...
```bat
cd /d C:\slicerSTRT\workspace\build_scripts
...
3. Borra C:\slicerSTRT\apps\SR si existe.
4. Configura CMake.
...
```bat
dir C:\slicerSTRT\apps\SR\Slicer-build\Slicer.exe
dir C:\slicerSTRT\apps\SR\Slicer-build\bin\Release\SlicerApp-real.exe
```
