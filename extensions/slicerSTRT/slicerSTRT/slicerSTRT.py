...
class slicerSTRT(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = _("slicerSTRT")  # TODO: make this more human readable by adding spaces
...
See more information in <a href="https://github.com/organization/projectname#slicerSTRT">module documentation</a>.
""")
...
def registerSampleData():
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataCategory("slicerSTRT", title=_("slicerSTRT"))
...
class slicerSTRTWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setParameterNode(self, inputParameterNode: slicerSTRTParameterNode | None) -> None:
        """
